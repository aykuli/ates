...
Я бы, наверное, добавила схема режистри подмодулем в репозиторий, и чтоб этот подмодуль репы брали всегда какую-то ветку, например, master.
Таким образом, при открвании репы всегда будет браться новая версия схемы.
